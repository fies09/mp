...
from ctypes import *
from modules.Industrial_camera.MvImport.CameraParams_const import *
from modules.Industrial_camera.MvImport.CameraParams_header import *
from modules.Industrial_camera.MvImport.MvCameraControl_header import *
from modules.Industrial_camera.MvImport.MvErrorDefine_const import *
from modules.Industrial_camera.MvImport.PixelType_const import *
from modules.Industrial_camera.MvImport.PixelType_header import *
...
# MvCamCtrldll = ctypes.cdll.LoadLibrary("/opt/MVS/lib/64/libMvCameraControl.so.3.1.3.0")
...
class MvCamera():
    ...
    # 设置Command型属性值
    def MV_CC_SetCommandValue(self, strKey, sValue):
        MvCamCtrldll.MV_CC_SetCommandValue.argtype = (c_void_p, c_void_p)
        MvCamCtrldll.MV_CC_SetCommandValue.restype = c_uint
        # C原型:int MV_CC_SetCommandValue(void* handle,char* strKey)
        return MvCamCtrldll.MV_CC_SetCommandValue(self.handle, strKey.encode('ascii'), sValue.encode('ascii'))
    ...
    # 设置相机采集模式
    def MV_CC_SetAcquisitionMode(self, strKey=0):
        MvCamCtrldll.MV_CC_SetAcquisitionMode.argtype = (c_void_p, c_void_p)
        MvCamCtrldll.MV_CC_SetAcquisitionMode.restype = c_uint
        # C原型:int MV_CC_SetCommandValue(void* handle,char* strKey)
        return MvCamCtrldll.MV_CC_SetAcquisitionMode(self.handle,  c_uint(strKey))
